...
## Project Structure
    ...
    ├── datamodelerror_dev_89400  # Django project configurations
...
1. Clone this repo and `cd datamodelerror_dev_89400`
...
2. Clone this repo and `cd datamodelerror_dev_89400`
