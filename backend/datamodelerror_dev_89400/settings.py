"""
Django settings for datamodelerror_dev_89400 project.
...
ROOT_URLCONF = 'datamodelerror_dev_89400.urls'
...
WSGI_APPLICATION = 'datamodelerror_dev_89400.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "datamodelerror_dev_89400 API",
    "DESCRIPTION": "API documentation for datamodelerror_dev_89400 App",
    "VERSION": "v1",
}
